...
def dynamic_conversation_memory(agent_a, agent_b, initial_message_path, backstory_path, interactions=5):
    conversation = dynamic_conversation(agent_a, agent_b, initial_message_path, backstory_path, interactions=5)
    info = resume_conversation(conversation)
